...
@NgModule({
  ...
  exports: [LoadingComponent, ErrorMessagingComponent, MaterialModule,YesNoDialogComponent, FormattedNumberPipe, FormattedCurrencyPipe, MatDatepickerComponent,FormattedNumberInputDirective,FormattedCurrencyInputDirective,SuccessMessagingComponent]
})
